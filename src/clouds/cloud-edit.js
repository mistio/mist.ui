...
Polymer({
  _template: html`
        ...
        <app-form fields="{{fields}}" url="/api/v1/clouds/[[cloud.id]]" method="PATCH" on-request="_editCloudRequest" on-response="_editCloudsResponse" btncontent="Edit Credentials" show-cancel=""></app-form>
`,
