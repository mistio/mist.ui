...
Polymer({
  _template: html`
        ...
        <div id="content">
            ...
            <template is="dom-if" if="[[_canShowHostsList(cloud.provider)]]" restamp="">
        ...
        <iron-ajax id="cloudEditOBSLOGSAjaxRequest" url="/api/v1/clouds/[[cloud.id]]" handle-as="xml" method="POST" on-response="_handleCloudEditOBSLOGSAjaxResponse" on-error="_handleCloudEditOBSLOGSAjaxError" loading="{{obsloading}}"></iron-ajax>
