                            ...
                            <div class\$="[[item.class]]">
                                <template is="dom-repeat" items="[[item.categories]]" as="category">
                                    <!-- <div class\$="[[category.class]]">-->
                                        ...
                                        <paper-listbox class="providers" attr-for-selected="value" selected="{{selectedProvider}}">
...
`,
  ...
  updateKeysInLists (e, lists) {
      for (let j = 0; j < lists.length; j++) {
          const keyFieldsIndexes = this.fieldsOfType(this.providerFields[lists[j]].options,
              'ssh_key');
