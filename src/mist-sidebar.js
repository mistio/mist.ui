                ...
                <nav>
                    <template is="dom-repeat" items="[[sectionsArray]]">
                        <template is="dom-if" if="[[item.sidebar]]" restamp="">
                            <a id="[[item.id]]" class="section" on-tap="clearSearch" id\$="[[item.id]]" href\$="/[[item.id]]" hidden\$="[[_isHidden(item,sectionsArray)]]" active\$="[[_isEqual(current, item.id)]]" tabindex="1">
                                <div class="flex-1 layout horizontal center">
                                    ...
                                    <span class="title flex-1">
                                        ...
                                        <span class="count">[[_getSectionCount(item.id, sectionsArray)]]</span>
                                    </span>
                                </div>
                            </a>
