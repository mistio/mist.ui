            ...
            <paper-material>
                <div class="grid-row">
                    ...
                    <paper-dropdown-menu class="xs12 m6" label="Catalogue Templates" horizontal-align="left">
                        <paper-listbox slot="dropdown-content" attr-for-selected="value" selected="{{selected}}" class="dropdown-content">
  ...
  showWarning(fields) {
      ...
      if (fields.path === "fields.#8.value") {
          if (fields.value){
              ...
              this.set('fields.#8.helptext', 'Enable to allow team members to run this template with owner priviledges.');
          }
      }
  }
});
