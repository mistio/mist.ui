        ...
        <paper-dialog id="form" with-backdrop="" modal="">
            ...
            <div class="head">
                ...
                <p class="desc" hidden\$="[[addCard]]">
                    <span hidden\$="[[!hasPlan]]">Subscription of \$[[plan.price]]/mo. <br> Up to [[displayInt(plan.vcpu_limit)]] vCPUs</span>
                </p>
...
`,
  ...
  purchaseResponse(_e){
      ...
      if (this.addCard) {
          ...
          this.dispatchEvent(new CustomEvent('toast', { bubbles: true, composed: true, detail:  {msg: 'Plan changed.', duration: 3000} }));
      }
