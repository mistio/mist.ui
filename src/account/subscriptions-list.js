        ...
        <paper-card>
            ...
            <div class="card-content">
                <div class="info-list">
                    ...
                    <div class="info-body">
                        <template is="dom-repeat" items="{{org.subscription_history}}" as="subscription">
                            <div class="row">
                                <subscription-item subscription="[[subscription]]" index="[[index]]" count="[[subscriptions.length]]"></subscription-item>
                            </div>
                        </template>
                    </div>
                </div>
