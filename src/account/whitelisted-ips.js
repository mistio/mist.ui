        ...
        <paper-material>            
            <div class="grid-row">
                ...
                <div class="ips-section xs12 m12 l12">
                    ...
                    <multi-inputs with-description="" input-label="cidr" inputs-array="{{whiteIps}}" event-name="save-ips" default-input="[[user.current_ip]]" show-add-default="[[showAddCurrent]]"></multi-inputs>
                </div>
                ...
                <div class="bottom-actions clearfix xs12">
                    <paper-button id="save_ips" on-tap="_saveWhitelist" raised="" disabled\$="[[!ipsFormReady]]" class="blue">Save IPs</paper-button>

                    <iron-ajax id="ipsRequest" url="/api/v1/whitelist" method="POST" handle-as="xml" loading="{{loadingIp}}" on-response="_handleIpResponse" on-error="_handleIpError"></iron-ajax>
                </div>
            </div>
        </paper-material>
