...
Polymer({
  _template: html`
        ...
        :host([current]) .plan-body-item+.plan-body-item, :host([current]) .plan-body-item:last-child{
            border: 0 none;
        }
                        ...
                        <div class="payg-info" hidden\$="[[plan.title]]">
                            ...
                            <div hidden\$="[[plan.title]]">
                                ...
                                <template is="dom-if" if="[[!hasCard]]" restamp="">
                                    <paper-button class="blue" raised="" on-tap="_purchasePlan">Enable</paper-button>
                                    <p class="margin-24">14 days of <strong>free trial</strong>.</p>
                                </template>
                                <template is="dom-if" if="[[trialDaysLeft]]">
                                    <p><span class="days-left">[[trialDaysLeft]]</span> days <br>
            ...
            <template is="dom-if" if="[[!plan.vcpu_limit]]" restamp="">
                <div class="plan old">
                    ...
                    <div class="old-plan-body">
                        ...
                        <template is="dom-if" if="[[showPurchase(plan, current)]]" restamp="">
                            <paper-button id="select" class="btn-block submit-btn blue" on-tap="_purchasePlan">Purchase</paper-button>
                        </template>
                ...
                <div class="plan">
                    ...
                    <div class="plan-body">
                        <div class="plan-body-item">
                            <div class="valign">
                                <h2 class="price"><sup>\$</sup>[[_formatMoney(plan.price)]]<sub>/mo.</sub></h2>
                                <template is="dom-if" if="[[showPurchase(plan, current)]]" restamp="">
                        ...
                        <div class="plan-body-item">
                            ...
                            <p class="valign" hidden\$="[[!plan.retention]]">[[plan.retention]] retention</p>
                        </div>
                        <template is="dom-if" if="[[plan.expiration]]">
                            <div class="plan-body-item">
...
`,
  ...
  _purchasePlan(_e) {
      ...
      if (this.plan && !this.plan.price) {
          ...
          this.dispatchEvent(new CustomEvent('plan-selected', {bubbles: true, composed: true}));
      }
  },
