        ...
        <paper-material>
            <div class="grid-row">
                ...
                <div class="plans xs12 s6 m6 l6">
                    <plan-item plan="[[org.current_plan]]" current="" class="plan" email="[[email]]" has-card="[[hasCard]]" trial-days-left="[[org.trial_days_left]]"></plan-item>
                </div>
                <div class="xs12 s6 m6 l6" hidden\$="[[org.card]]">
                    <p>For questions and other information contact us at <a href\$="mailto:[[email.sales]]">[[email.sales]]</a></p>
                </div>
                <template is="dom-if" if="[[org.card]]" restamp="">
                    <div class="xs12 s6 m6 l6" hidden\$="[[!org.card]]">
                        <h2 class="title balance-title">Your Balance
                            <span class="secondary" hidden\$="[[!org.trial_days_left]]"><br>You are in free trial until [[computeStartChargingDay(org.trial_days_left)]].</span></h2>
                        <div class="balance">
                ...
                <div class="plans xs12">
                    <template is="dom-if" if="[[org]]" restamp="">
                        <template is="dom-repeat" items="[[plans]]" as="plan" restamp="">
                            <plan-item plan="[[plan]]" class="plan" email="[[email]]" has-card="[[hasCard]]" trial-days-left="[[org.trial_days_left]]"></plan-item>
                        </template>
                    </template>
                </div>
