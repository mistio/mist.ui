        ...
        <div id="content">
            ...
            <paper-material>
                ...
                <div class="grid-row">
                    ...
                    <paper-textarea id="privateKey" class="xs12" label="Private Key" rows="5" required="" auto-validate="" error-message="Please enter private key" value="{{key.privateKey}}" max-rows="5"></paper-textarea>
