            ...
            <template>
                ...
                <div class="paper-dialog-scrollable">
                    ...
                    <div class="clearfix btn-group">
                        <paper-button class="blue-link" dialog-dismiss="" on-tap="_closeEditTeamModal">Cancel</paper-button>
                        <paper-button class="submit-btn btn-block" disabled\$="[[!formReady]]" raised="" on-tap="_submitForm">Submit</paper-button>
                    </div>
                </div>
            </template>
        </vaadin-dialog>
        <iron-ajax id="teamEditAjaxRequest" url="/api/v1/org/[[org]]/teams/[[team.id]]" method="PUT" on-response="_handleTeamEditAjaxResponse" on-error="_handleTeamEditAjaxError"></iron-ajax>
`,
