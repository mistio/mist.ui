...
Polymer({
  _template: html`
        ...
        <span class="resource">
            ...
            <span class="uppercase">
                <paper-dropdown-menu no-animations="" no-label-float="">
                  <paper-listbox slot="dropdown-content" class="dropdown-content" attr-for-selected="value" selected="{{_computeSelectedType(rule.rtype)}}" on-iron-activate="selectType">
        ...
        <span class="action">
            <span class="uppercase">
                <paper-dropdown-menu no-animations="" no-label-float="">
                  <paper-listbox slot="dropdown-content" class="dropdown-content" attr-for-selected="value" selected="{{_computeSelectedAction(rule.action)]]" on-iron-activate="selectAction">
        ...
        <span class="constraints">
            <rbac-rule-constraints model="[[model]]" rule="[[rule]]" index="[[index]]"></rbac-rule-constraints>
        </span>
        <span class="delete">
