...
Polymer({
  _template: html`
    ...
    <schedule-edit-selector id="editScheduleSelector" schedule="[[items.0]]" model="[[model]]" machines-age="[[machineAge]]" machines-cost="[[machinesCost]]" currency="[[currency]]"></schedule-edit-selector>
