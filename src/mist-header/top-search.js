...
import '@mistio/mist-list/mist-filter.js';
...
Polymer({
  _template: html`
        ...
        <div id="search" class="horizontal layout">
            <mist-filter id="topFilter" user-filter="{{userFilter}}" display-name="{{displayName}}" preset-filters="[[presetFilters]]" name\$="[[_computeFilterPlaceholder(title)]]">
            </mist-filter>
        </div>
