                ...
                <ul>
                    <template is="dom-repeat" items="[[results.cloudsArray]]">
                        <li class="truncate">
                            ...
                            <a href="/clouds/[[item.id]]" on-tap="closeSuggestions">[[item.title]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.machines]]">
                        <li class="truncate">
                            ...
                            <a href="/machines/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.imagesArray]]">
                        <li class="truncate">
                            ...
                            <a href="/images/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.keysArray]]">
                        <li class="truncate">
                            ...
                            <a href="/keys/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.networks]]">
                        <li class="truncate">
                            ...
                            <a href="/networks/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.tunnelsArray]]">
                        <li class="truncate">
                            ...
                            <a href="/tunnels/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.scriptsArray]]">
                        <li class="truncate">
                            ...
                            <a href="/scripts/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.schedulesArray]]">
                        <li class="truncate">
                            ...
                            <a href="/schedules/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.templatesArray]]">
                        <li class="truncate">
                            ...
                            <a href="/templates/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.stacksArray]]">
                        <li class="truncate">
                            ...
                            <a href="/stacks/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.teamsArray]]">
                        <li class="truncate">
                            ...
                            <a href="/teams/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                ...
                <ul>
                    <template is="dom-repeat" items="[[results.membersArray]]">
                        <li class="truncate">
                            ...
                            <a href="/members/[[item.id]]" on-tap="closeSuggestions">[[item.name]]</a>
                        </li>
                    </template>
                </ul>
            </div>
