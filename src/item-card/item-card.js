...
Polymer({
  _template: html`
        ...
        <a href="[[_getitemLink(item.id)]]">
            </a><div id="content" class="vertical layout"><a href="[[_getitemLink(item.id)]]">
                <div id="el" view="docs">
                ...
                </a><div class="horizontal layout center meta section"><a href="[[_getitemLink(item.id)]]">
                    <section-symbol icon="[[section.icon]]" color="[[section.color]]"></section-symbol>
                    </a><a href="[[_getSectionLink(item.section)]]">[[section.id]]</a>
                </div>
                <div class="meta tags">
...
`,
  ...
  showActions() {
      ...
      if (!sharedActionMenu) {
          ...
          sharedActionMenu.addEventListener('mouseenter', mouseEnter, {passive: true});
          sharedActionMenu.addEventListener('mouseleave', mouseLeave, {passive: true});
      }
