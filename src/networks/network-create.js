  ...
  _template: html`
        ...
        <div id="content">
            ...
            <paper-material hidden\$="[[hasCloudsWithNetworks]]">
                <p>To add a network you need to have an enabled Openstack, Gig G8, GCE or EC2 cloud in your account.
            ...
            <template is="dom-if" if="[[selectedCloud]]" restamp="">
                <paper-material>
                    <app-form id="network_add" fields="{{fields}}" form="[[form]]" url="/api/v1/clouds/[[selectedCloud]]/networks" on-response="_handleCreateNetworkResponse" on-error="_handleError" format-payload=""></app-form>
                </paper-material>
            </template>
        </div>
`,
