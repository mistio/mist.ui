...
Polymer({
  _template: html`
        ...
        <iron-ajax id="networkDeleteAjaxRequest" url="/api/v1/clouds/[[network.cloud]]/networks/[[network.id]]" method="DELETE" on-response="_handleNetworDeletekAjaxResponse"></iron-ajax>
