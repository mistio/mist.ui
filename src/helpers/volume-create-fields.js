  ...
  fields: [
    {
      ...
      defaultValue: '',
      helptext:
        'If a filesystem type is selected, the volume will automatically be formatted to the specified filesystem type.',
      show: true,
      required: false,
      options: [
        {
...
VOLUME_CREATE_FIELDS.push({
  ...
  fields: [
    ...
    },
    {
      ...
      helptext:
        'Maximum ratio is 50 IOPS/GiB. Range is 100 to 32000 IOPS for volumes in most regions',
      showIf: {
...
VOLUME_CREATE_FIELDS.push({
  ...
  fields: [
    ...
    },
    {
      ...
      required: true,
      helptext:
        'Enable id shifting overlay (allows attach by multiple isolated containers).',
    },
    {
      name: 'path',
      label: 'Path *',
