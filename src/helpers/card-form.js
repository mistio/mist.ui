...
Polymer({
  _template: html`
        ...
        <div class="form-inputs">
            <gold-cc-input id="cc" required="" auto-validate="" autofocus="" card-type="{{cardType}}" data-stripe="number" value="{{payload.number::input}}">
            </gold-cc-input>
            <gold-cc-cvc-input id="cvc" required="" auto-validate="" card-type="[[cardType]]" label="CVC" value="{{payload.cvc::input}}"></gold-cc-cvc-input>
            <div class="align">
