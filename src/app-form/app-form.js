...
Polymer({
  _template: html`
    ...
    <div class$="grid [[_computeLayoutClass(horizontalLayout)]]">
      ...
      >
        <template
          is="dom-if"
          if="[[_showField(field, index, fieldVisibility.*)]]"
          restamp=""
        >
          <div class="grid-row">
            <h3 class="xs12 s12 m12 l12" hidden$="[[!field.h3]]">
              [[field.h3]]
            </h3>
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'text', fieldVisibility, index)]]"
              restamp=""
            >
              <paper-input
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'number', fieldVisibility, index)]]"
              restamp=""
            >
              <paper-input
                class$="xs12 m6 [[field.class]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'password', fieldVisibility, index)]]"
              restamp=""
            >
              <paper-input
                class$="xs12 m6 [[field.class]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'textarea', fieldVisibility, index)]]"
              restamp=""
            >
              <paper-textarea
                class$="xs12 m6 [[field.class]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'ip_textarea', fieldVisibility, index)]]"
              restamp=""
            >
              <paper-textarea
                class$="xs12 m6 [[field.class]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'radio', fieldVisibility, index)]]"
              restamp=""
            >
              <paper-radio-group
                id$="app-form-[[id]]-[[field.name]]"
              ...
              >
                <template is="dom-repeat" items="[[field.options]]" as="option">
                  <paper-radio-button
                    ...
                    >[[option.title]]</paper-radio-button
                  >
                </template>
              </paper-radio-group>
            </template>
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'checkbox', fieldVisibility, index)]]"
              restamp=""
            >
              <div
                id$="app-form-[[id]]-[[field.name]]"
                class$="dropdown-block xs12 m6 [[field.class]] checkboxes"
                hidden$="[[field.hidden]]"
              >
                <paper-checkbox
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'checkboxes', fieldVisibility, index)]]"
              restamp=""
            >
              <div
                id$="app-form-[[id]]-[[field.name]]"
              ...
              >
                <div
                  hidden$="[[!_noOptions(field.options, field.options.length)]]"
                >
                  <paper-item disabled=""
                    >No [[_computeResourceTypeForField(field.name,
                    field.options.length)]] found.
                    [[field.noOptionsMessage]]</paper-item
                  >
                </div>
                <div
                  hidden$="[[_noOptions(field.options, field.options.length)]]"
                >
                  <span class="checkboxes-label" hidden$="[[field.label]]"
                    >[[field.name]]:</span
                  >
                  <span class="checkboxes-label" hidden$="[[!field.label]]"
                    >[[field.label]]:</span
                ...
                <template is="dom-repeat" items="[[field.options]]" as="option">
                  <template is="dom-if" if="[[!option.id]]">
                    <span class="checkboxes-category"
                      ><strong>[[option]]</strong></span
                    >
                  </template>
                  <template is="dom-if" if="[[option.id]]">
                    <paper-checkbox
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'dropdown', fieldVisibility, index)]]"
              restamp=""
            >
              <paper-dropdown-menu
                id$="app-form-[[id]]-[[field.name]]"
              ...
              >
                ...
                >
                  <template
                    is="dom-if"
                    if="[[_noOptions(field.options, field.options.length)]]"
                    restamp=""
                  >
                    <paper-item disabled=""
                      >No [[_computeResourceTypeForField(field.name,
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'mist_size', fieldVisibility, index)]]"
              restamp=""
            >
              <mist-size-field
                id$="app-form-[[id]]-[[field.name]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'mist_machine', fieldVisibility, index)]]"
              restamp=""
            >
              <mist-machine-field
                id$="app-form-[[id]]-[[field.name]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'mist_networks', fieldVisibility, index, field.options)]]"
              restamp=""
            >
              <mist-networks-field
                id$="app-form-[[id]]-[[field.name]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'mist_tags', fieldVisibility, index)]]"
              restamp=""
            >
              <mist-tags-field
                id$="app-form-[[id]]-[[field.name]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'duration_field', fieldVisibility, index)]]"
              restamp=""
            >
              <duration-field
                id$="app-form-[[id]]-[[field.name]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'mist_dropdown', fieldVisibility, index)]]"
            >
              <paper-dropdown-menu
                class$="dropdown-block xs12 m6 [[field.class]]"
                label="[[field.label]]"
                ...
                >
                  ...
                  >
                    <paper-item disabled=""
                      ...
                      found.[[field.noOptionsMessage]]</paper-item
                    >
                  </template>
                  <template
                    is="dom-repeat"
                  ...
                  >
                    <paper-item
                      value="[[_getPayloadValue(field,option)]]"
                    ...
                    >
                      ...
                      <span
                        ...
                        data-prefix$="[[option.prefix]]"
                        data-suffix$="[[option.suffix]]"
                        >[[showOption(option,field)]]</span
                      >
                    </paper-item>
                  </template>
                  <paper-button
                    on-tap="_addInput"
                    class="blue add-input"
                    hidden$="[[!field.add]]"
                    >Add
                    [[_computeResourceTypeForField(field.name)]]</paper-button
                  >
                </paper-listbox>
              </paper-dropdown-menu>
            </template>
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'mist_dropdown_searchable', fieldVisibility, index)]]"
            >
              <paper-dropdown-menu
                class$="dropdown-block xs12 m6 [[field.class]]"
                label="[[field.label]]"
              ...
              >
                <div slot="dropdown-content" class="dropdown-content">
                  ...
                  >
                    <template
                      is="dom-if"
                      if="[[_noOptions(field.options, field.options.length, field.loader)]]"
                      restamp=""
                    >
                      <paper-item disabled=""
                        >No [[_computeResourceTypeForField(field.name,
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'slider', fieldVisibility, index)]]"
            >
              <div class="xs12 m12 l12" hidden="[[field.hidden]]">
                [[field.label]]
                <span class="field-helptext"
                  >min [[field.min]], max [[field.max]] [[field.unit]]</span
                >
              </div>
              <paper-slider
                class$="xs12 m6 [[field.class]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'ssh_key', fieldVisibility, index)]]"
            >
              <paper-dropdown-menu
                class="dropdown-block xs12 m6"
                label="[[field.label]]"
                horizontal-align="left"
                hidden$="[[field.hidden]]"
              >
                ...
                >
                  ...
                  >
                    <template
                      ...
                      as="option"
                    >
                      <paper-item value="[[option.id]]"
                        >[[option.name]]</paper-item
                      >
                    </template>
                    <paper-button on-tap="_addKey" class="blue add-input"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'toggle', fieldVisibility, index)]]"
            >
              <div class="xs12 m6">
                <paper-toggle-button
                  id$="app-form-[[id]]-[[field.name]]"
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'date', fieldVisibility, index)]]"
            >
              <div class$="xs12 m6 date [[field.class]]">
                <div class="date-label">[[field.label]]</div>
                <div
                  id="date"
                  class$="simple-button valid-[[_validateDatetime(field, field.value)]]"
                >
                  ...
                  <div class="datetime-picker-with-button">
                    ...
                    <iron-icon
                      ...
                      icon="clear"
                      on-tap="_clearDateTimeInput"
                      hidden$="[[_showClearDateBtn(field, field.value)]]"
                    ></iron-icon>
                  </div>
                </div>
                <div
                  class="error"
                  hidden$="[[_validateDatetime(field, field.value)]]"
                >
                  [[field.errorMessage]]
                </div>
              </div>
            ...
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'list', fieldVisibility, index)]]"
            >
              ...
              <sub-form
                ...
                moderate-top="[[f.moderateTop]]"
                items="[[field.items]]"
                class$="xs12 m12 [[field.class]]"
              ></sub-form>
            </template>
            <template
              is="dom-if"
              if="[[_compareFieldType(field.type, 'fieldgroup', fieldVisibility, index)]]"
            >
              <sub-fieldgroup
                id$="fieldgroup-[[id]]"
                field="[[field]]"
                class$="xs12 m6 l6 [[field.class]]"
                optional=""
              ></sub-fieldgroup>
            </template>
            <div
      ...
      <template is="dom-if" if="[[displayButtons]]">
        ...
        <div class="clearfix bottom-actions xs12">
          ...
          <paper-button
            id="appformsubmit"
            class$="submit-btn pull-right blue [[btnClass]]"
            disabled$="[[!formReady]]"
            raised=""
            on-tap="_submitForm"
          >
            ...
            <template is="dom-if" if="[[!btncontent]]"> Add </template>
          </paper-button>
        </div>
      </template>
    </div>
    <iron-ajax
      ...
      handle-as="json"
      last-response="{{data}}"
      on-response="_getJSONResponse"
      on-request="_getJSONRequest"
      on-error="_getJSONError"
    ></iron-ajax>
    <iron-ajax
      id="formAjax"
      url="[[url]]"
  ...
  observers: ['_fieldsChanged(fields.*, loading)'],
  ...
  showOption(option, field) {
    if (field.display) return option[field.display];
  ...
  _getJSONResponse(e) {
    ...
    if (this.fieldIndex > -1) {
      ...
      this.set(
        `fields.${this.fieldIndex}.${options}`,
        e.detail.response[options]
      );
      this.set(
        `fields.${this.fieldIndex}.helptext`,
        e.detail.response.helptext
      );
  ...
  _fieldsChanged(fields, _loading) {
    ...
    if (
      fields &&
      !fields.path.endsWith('.show') &&
      !fields.path.endsWith('.loader')
    ) {
      const that = this;

      this.debounce(
        'fieldsChangedDebouncer',
        () => {
          const { form } = that;
          let show = true;
          let dependency;
          ...
          that.fields.forEach((el, index) => {
            if (el.eventOnChange) {
              if (el.previousValue !== el.value) {
                ...
                that.dispatchEvent(
                  new CustomEvent(el.eventOnChange, {
                    bubbles: true,
                    composed: true,
                  })
                );
            ...
            if (
              el.schemeLoaderFor &&
              (fields.path === 'fields' ||
                fields.path === `fields.${index}.value`)
            ) {
            ...
            if (el.showIf) {
              ...
              if (parent && parent.showIf) {
                ...
                if (parent.showIf.fieldExists) {
                  ...
                  parentShow =
                    parent.showIf.fieldValues.indexOf(parentDependency) !== -1;
                }
              ...
              if (el.type === 'list') {
                ...
                if (el.items && el.items.length) {
                  for (let i = 0; i < el.items.length; i++) {
                    ...
                    for (let j = 0; j < el.items[i].length; j++) {
                      if (that._includeInPayload(el.items[i], el.items[i][j]))
                        fieldPayload[el.items[i][j].name] =
                          el.items[i][j].value;
                    }
                ...
                that.set(
                  `form.${el.name}`,
                  that._constructTagsValue(textToArray)
                );
            ...
            that.fields.forEach((depel, ind) => {
              if (
                ...
                if (depel.options) {
                  that.set(`fields.${ind}.options`, depel.options);
                }
              }
            });
          });
    ...
    return fieldsToValidate.every((el, _index) => {
      ...
      if (el.name === 'cloud_init') {
        return (
          ...
          (el.value.startsWith('#!/bin/bash') ||
            el.value.startsWith('#cloud-config') ||
            el.value.trim() === '')
        );
      }
  ...
  _validateTags(field) {
    return (
      JSON.stringify(this._constructTagsValue(field.value.split(','))).length >
      2
    );
  },
  ...
  _validateDatetime(el) {
    if (!el.value) return !el.required || !el.show;
  ...
  _validateMistSize(el) {
    return el.value === 'custom'
      ? this._validateCustomValue(el.customSizeFields, el.customValue)
      : el.value.length;
  },
  ...
  _validateCustomValue(customSizeFields, customValue) {
    ...
    if (customSizeFields && customValue) {
      for (let i = 0; i < customSizeFields.length; i++) {
        if (
          customValue[customSizeFields[i].name] === undefined ||
          customValue[customSizeFields[i].name] === ''
        ) {
  ...
  _validatePatternedField(el) {
    const fieldName = this.id
      ? `paper-input#app-form-${this.id}-${el.name}`
  ...
  _submitForm(_e) {
    ...
    if (this.formatPayload) {
      this.dispatchEvent(
        new CustomEvent('format-payload', { bubbles: true, composed: true })
      );
    }
    ...
    if (this.workflow) {
      ...
      for (const p of Object.keys(inps)) {
        ...
        if (field.excludeFromPayload === true) {
          ...
          if (
            field.preformatPayloadValue !== undefined &&
            field.preformatPayloadValue.apply
          ) {
      ...
      this.fields.forEach(field => {
        ...
        if (field.type === 'list') {
          ...
          if (field.items && field.items.length) {
            for (let i = 0; i < field.items.length; i++) {
              ...
              for (let j = 0; j < field.items[i].length; j++) {
                if (this._includeInPayload(field.items[i], field.items[i][j]))
          ...
          payload[field.name] = moment
            .unix(field.value / 1000)
            .utc()
  ...
  _includeInPayload(list, field) {
    ...
    if (field.showIf && (field.showIf.fieldExists || field.showIf.fieldName)) {
      ...
      if (
        ...
        (field.showIf.fieldValues &&
          field.showIf.fieldValues.indexOf(d.value) > -1)
      )
        return true;
    }
    return false;
  ...
  _cancel() {
    const overlay = document.querySelector('vaadin-dialog-overlay');
    if (overlay) overlay.opened = false;
  },
    ...
    this.fields.forEach((el, index) => {
      ...
      if (el.type === 'list') {
        for (let i = 0; i < el.options.length; i++) {
          this.set(
            `fields.${index}.options.${i}.value`,
            this.get(`fields.${index}.options.${i}.defaultValue`) || ''
          );
        }
      }
  ...
  _validateCidrArray(field) {
    ...
    if (ipArray.length === 0) return false;
  ...
  _computeResourceTypeForField(str, length) {
    let ret = str
      ? str
          ...
          .trim()
      : '';
    if (length !== undefined && length > 1) ret += 's';
    return ret;
  },
  ...
  _helpTap(e) {
    this.dispatchEvent(
      new CustomEvent('user-action', {
        bubbles: true,
        composed: true,
        detail: `open help ${e.model.field.helpHref}`,
      })
    );
  },
  ...
  _getFieldNameById(str) {
    return this.id
      ? str.split(`app-form-${this.id}-`)[1]
      : str.split('app-form--')[1];
  },
